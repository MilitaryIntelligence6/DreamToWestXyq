...
import cn.misection.dreamwest.ui.activity.SpriteActivity;
...
//        int x=520,y=100,width=66,height=143;
        ...
        LButton btnSave = new LButton("保 存 进 度", 5, 33, 146, 36) {
            public void doClick() {
                ...
                //TODO 保存
                UIHelper.prompt(MainActivity.getInstance().getScreen(), "暂不支持", 3000);
            }
        };
        ...
        LButton btnBack = new LButton("继 续 游 戏", 5, 185, 146, 36) {
            public void doClick() {
                ...
                SpriteActivity.getInstance().closeOptionsMenu();
            }
        };
